"""Секция настроек эмбеддера BGE Large Ru (Sentence-Transformers)."""
...
class BGELargeRuEmbeddingSettings(SettingsBase):
    """Настройки эмбеддера BGE Large."""

    model_name: str = Field(
        "BAAI/bge-large-ru",
        env="EMBED_BGE_LARGE_RU_MODEL_NAME",
    ...
    max_tokens: int = Field(
        512,
        env="EMBED_BGE_LARGE_RU_MAX_TOKENS",
